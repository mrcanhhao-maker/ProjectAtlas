...
print("VisionRow Alpha 7 Test.1 dang chay")
...
while True:
    ...
    if result.pose_landmarks:
        ...
        if l_shoulder and r_shoulder and l_hip and r_hip:
            ...
            stroke.update(angle)
            motion_v2.update(angle, skeleton_found=True)
    ...
    cv2.putText(frame, "VisionRow Alpha 7 Test.1", (20, 35), cv2.FONT_HERSHEY_SIMPLEX, 0.85, (255,255,255), 2)
    ...
    cv2.imshow("VisionRow Alpha 7 Test.1", frame)
